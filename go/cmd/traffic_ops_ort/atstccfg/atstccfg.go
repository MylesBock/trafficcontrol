...
// 	-e ERROR_LOCATION, --log-location-error ERROR_LOCATION          The file location to which to log errors. Respects the special string constants of github.com/apache/trafficcontrol/pkg/log. Default: 'stderr'
...
// 	-i INFO_LOCATION, --log-location-info INFO_LOCATION             The file location to which to log information messages. Respects the special string constants of github.com/apache/trafficcontrol/pkg/log. Default: 'stderr'
...
// 	-w WARNING_LOCATION, --log-location-warning WARNING_LOCATION    The file location to which to log warnings. Respects the special string constants of github.com/apache/trafficcontrol/pkg/log. Default: 'stderr'
//
...
import (
	...
	"github.com/apache/trafficcontrol/internal/pkg/traffic_ops_ort/atstccfg/cfgfile"
	"github.com/apache/trafficcontrol/internal/pkg/traffic_ops_ort/atstccfg/config"
	"github.com/apache/trafficcontrol/internal/pkg/traffic_ops_ort/atstccfg/getdata"
	"github.com/apache/trafficcontrol/internal/pkg/traffic_ops_ort/atstccfg/plugin"
