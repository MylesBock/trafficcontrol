...
const dockerCompose = ["docker-compose",
	"-f", "mainline/deployments/cdn-in-a-box/docker-compose.yml",
	"-f", "mainline/deployments/cdn-in-a-box/docker-compose.readiness.yml"];
...
runProcess(...dockerCompose, "build", "trafficops-perl");
